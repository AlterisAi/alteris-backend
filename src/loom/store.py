...
class LayeredGraphStore:
    ...
    def __init__(self, db_path: Path | str | None = None):
        from loom.constants import DEFAULT_DB_PATH
        if db_path == ":memory:":
    ...
    def upsert_person_profile(self, profile: dict) -> bool:
        ...
        self.conn.execute(
            """INSERT INTO person_profiles
               (person_id, canonical_name, message_count, tier,
                user_initiated_ratio, channels, channel_count,
    ...
    def push_cq_undo(self, action: str, task_id: str, prev_state: dict):
        ...
        from loom.constants import CQ_UNDO_MAX_ENTRIES
        now = int(time.time())
        self.conn.execute(
    ...
    def prune_cq_undo(self, max_age_seconds: int | None = None):
        ...
        from loom.constants import CQ_UNDO_MAX_AGE_SECONDS
