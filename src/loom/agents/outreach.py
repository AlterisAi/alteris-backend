...
from loom.agents.protocol import VCProfile, route_vc, score_vc_focus, build_pitch_angle
...
def _dossier_to_profile(name: str, firm: str, result: dict) -> VCProfile:
    ...
    best_cred = 6
    if sources_used:
        from loom.agents.intel.sources import VCSourceType, admiralty_for_source
        rel_order = "ABCDEF"
