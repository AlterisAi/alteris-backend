"""Source adapter framework for Loom ingestion.
...
def get_all_adapters() -> list[SourceAdapter]:
    ...
    from loom.adapters.calendar import CalendarAdapter
    from loom.adapters.calls import MacOSCallAdapter, WhatsAppCallAdapter
    from loom.adapters.contacts import ContactsAdapter
    from loom.adapters.granola import GranolaAdapter
    from loom.adapters.imessage import IMessageAdapter
    from loom.adapters.mail import MailAdapter
    from loom.adapters.slack import SlackAdapter
    from loom.adapters.whatsapp import WhatsAppAdapter
...
def get_ambient_adapters() -> list[SourceAdapter]:
    ...
    from loom.adapters.chrome import get_chromium_adapters
    from loom.adapters.knowledgec import KnowledgeCAdapter
    from loom.adapters.notes import NotesAdapter
    from loom.adapters.safari import SafariAdapter
    from loom.adapters.shell_history import ShellHistoryAdapter
