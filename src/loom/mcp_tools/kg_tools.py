...
def handle_loom_stats(store: LayeredGraphStore, **kwargs) -> dict:
    """Return database statistics."""
    return store.stats()


def handle_loom_query_events(
...
def handle_loom_query_commitments(
    store: LayeredGraphStore,
    overdue: bool = False,
...
def handle_loom_get_briefing(
    ...
    **kwargs,
    ...
    briefing_dir = LOOM_DIR / "briefings"
...
def handle_loom_get_spend(
    ...
    **kwargs,
    ...
    try:
        from loom.spend import get_daily_spend, get_spend_summary, check_onboarding_budget
...
register_tool(ToolDef(
    ...
    permission="read",
    handler=handle_loom_stats,
))

register_tool(ToolDef(
    name="loom_query_events",
    ...
    handler=handle_loom_query_events,
))

register_tool(ToolDef(
    name="loom_query_beliefs",
    ...
    handler=handle_loom_query_beliefs,
))

register_tool(ToolDef(
    name="loom_query_persons",
    ...
    handler=handle_loom_query_persons,
))

register_tool(ToolDef(
    name="loom_query_commitments",
    ...
    handler=handle_loom_query_commitments,
))

register_tool(ToolDef(
    name="loom_person_detail",
    ...
    handler=handle_loom_person_detail,
))
...
register_tool(ToolDef(
    ...
    handler=handle_loom_search,
))

register_tool(ToolDef(
    name="loom_get_briefing",
    ...
    handler=handle_loom_get_briefing,
))
