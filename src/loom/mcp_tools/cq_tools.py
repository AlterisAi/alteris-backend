...
def _get_lookback_days() -> int:
    ...
    from loom.constants import CQ_DEFAULT_LOOKBACK_DAYS
...
def _get_lookahead_days() -> int:
    ...
    from loom.constants import CQ_DEFAULT_LOOKAHEAD_DAYS
    profile = _load_profile_yaml()
...
def _resolve_kg_commitment(store: LayeredGraphStore, task_id: str) -> None:
    ...
    """
    from loom.models import Event, SensitivityLevel
...
def handle_cq_get_state(store: LayeredGraphStore, date: str | None = None, **kwargs) -> dict:
    ...
    """
    from loom.constants import CQ_BUCKETS
...
def handle_cq_get_agenda(
    ...
    **kwargs,
    ...
    from loom.constants import safe_timezone
...
def handle_cq_chat(
    ...
    **kwargs,
    ...
    try:
        ...
        from loom.constants import CQ_COACHING_MODEL
...
def _build_chat_context(store: LayeredGraphStore) -> dict:
    ...
    """
    from loom.constants import CQ_MAX_CONTEXT_BELIEFS
