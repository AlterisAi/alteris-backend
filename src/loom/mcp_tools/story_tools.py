...
from loom.mcp_tools.cq_tools import _beliefs_to_tasks, _commitments_to_tasks
...
def _llm_cluster(store: LayeredGraphStore, tasks: list[dict]) -> list[dict] | None:
    ...
    """
    from loom.constants import CQ_CLUSTERING_MAX_TASKS, CQ_CLUSTERING_MODEL
...
def _llm_incremental_cluster(
    ...
    or None on failure.
    """
    from loom.constants import CQ_CLUSTERING_MODEL
...
def cluster_into_stories(
    ...
    """
    from loom.constants import CQ_CLUSTERING_CACHE_TTL
