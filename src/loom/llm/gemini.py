...
class GeminiClient(LLMClient):
    ...
    def _get_key(self) -> str:
        ...
        if not key:
            raise ValueError(
                ...
                "or ~/.loom/, add gemini_api_key to it, or set the "
        ...
        try:
            ...
            cache = client.caches.create(
                ...
                config=types.CreateCachedContentConfig(
                    ...
                    display_name=f"loom_{cache_key}",
                    ttl=f"{ttl_seconds}s",
                ),
            )
    ...
    def _check_spend_limit(self) -> None:
        ...
        if not self._store:
            return
        from loom.spend import check_limit
    ...
    def _record_spend(self, model_used: str, response: Any, source: str = "") -> None:
        ...
        try:
            from loom.spend import record_usage
            record_usage(
