...
def _meta(conn, now: int) -> dict:
    ...
    return {
        "system": "Alteris — computational autobiography. Constructs a living model of a person's digital existence from scattered traces across email, calendar, messaging, browser, shell, and app usage.",
        "data_dictionary": {
