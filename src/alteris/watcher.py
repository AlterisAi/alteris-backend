"""Continuous watch daemon for Alteris.
...
Usage:
    python -m alteris.cli watch --llm gemini -v
    python -m alteris.cli watch --dry-run --debounce 3
"""
...
class AlterisFileHandler(FileSystemEventHandler):
...
class WatchDaemon:
    ...
    def _start_file_watchers(self) -> Observer:
        ...
        for source_name, (watch_dir, target_files, recursive) in WATCH_TARGETS.items():
            ...
            handler = AlterisFileHandler(source_name, target_files, self.trigger)
