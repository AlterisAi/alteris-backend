...
function that produces a structured report against any Alteris database.

Usage:
    from alteris.eval.checks import run_stage0_checks
    report = run_stage0_checks("~/.alteris/graph.db")
"""
...
def write_markdown_report(
    ...
    md: list[str] = []
    md.append(f"# Alteris Eval Report")
    md.append(f"")
