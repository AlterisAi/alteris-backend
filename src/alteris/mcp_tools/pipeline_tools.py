...
def handle_alteris_run_pipeline(
...
def handle_alteris_run_ingest(
    ...
    **kwargs,
    ...
    import argparse
    from alteris.cli import cmd_ingest
...
def handle_alteris_update_profile(
    store: LayeredGraphStore,
...
def handle_alteris_reset_spend(
    store: LayeredGraphStore,
    bypass_code: str = "",
    date: str | None = None,
    **kwargs,
    ...
    try:
        from alteris.spend import verify_bypass_code, reset_daily_spend
    except ImportError:
...
register_tool(ToolDef(
    ...
    handler=handle_alteris_run_pipeline,
))

register_tool(ToolDef(
    name="alteris_run_ingest",
    ...
    handler=handle_alteris_run_ingest,
))

register_tool(ToolDef(
    name="alteris_update_profile",
    ...
    handler=handle_alteris_update_profile,
))

register_tool(ToolDef(
    name="alteris_reset_spend",
    ...
    handler=handle_alteris_reset_spend,
))
