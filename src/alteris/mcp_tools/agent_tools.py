...
Agents are stored as YAML files in ~/.alteris/agents/.
...
from alteris import agent_store
...
def handle_agent_create(
    ...
    **kwargs,
    ...
    from alteris.constants import AGENT_READ_TOOLS
...
def handle_agent_run(
    ...
    **kwargs,
    ...
    try:
        from alteris.agent_runtime import run_agent
...
- alteris_stats: Get database statistics
- alteris_query_events: Search events (email, messages, calendar, etc.)
- alteris_query_beliefs: Query synthesized beliefs about people, topics, commitments
- alteris_query_persons: List resolved person identities
- alteris_query_commitments: Query active commitments and deadlines
- alteris_person_detail: Deep info about a specific person
- alteris_search: Full-text search over all event content
